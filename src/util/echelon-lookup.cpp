...
std::string EchelonLookup::toString(EnhancedAstNodeType t) {
  switch (t) {
    ...
    case EnhancedAstNodeType ::FunctionCallParams:
      return "function call params";
    case EnhancedAstNodeType ::FunctionCallParam:
      return "function call param";
...
std::string EchelonLookup::toString(EnhancedAstNodeSubType t) {
  switch (t) {
    ...
    case EnhancedAstNodeSubType::Unspecified:
      return "unspecified";
    case EnhancedAstNodeSubType::Implementation:
      return "implementation";
    case EnhancedAstNodeSubType::Prototype:
      return "prototype";
