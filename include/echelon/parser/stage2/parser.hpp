...
private:
  ...
  ParserInternalOutput
  subProcess(std::list<Token *>::iterator start, std::list<Token *>::iterator end, TokenPatternGroup *nextGroup);
   ...
   */
  bool isTerminateForEndOfProgram(bool &patternMatches, std::list<Token *>::iterator current_token,
  ...
  bool isAllowMatchAtEndOfProgram(PatternMatchInfo *patternMatchInfo, TokenPattern *pattern,
                                  std::vector<TokenPatternGroup *>::iterator &current_group);
